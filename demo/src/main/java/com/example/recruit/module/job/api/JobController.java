package com.example.recruit.module.job.api;
...
public class JobController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<JobProfile> get(@PathVariable Long id) {
        return ResponseEntity.of(java.util.Optional.ofNullable(jobProfileService.getById(id)));
    }
